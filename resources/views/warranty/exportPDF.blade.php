...
<head>
    ...
    <title>Xuất file PDF bản 1 </title>
</head>
<style>
    table, th, td {
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <p style="text-align:center">Số/<span style="color: #77abd6;;margin:0">No:...............</span></p>
        ...
        <div class="row">
        <p class="border-bottom" style="font-size: 19px;font-weight: bold;margin:0;padding:5px 0">THÔNG TIN THIẾT BỊ <span style="color:rgb(237,125,49);font-size: 19px;">/ EQUIPMENT INFOMATION</span></p>
        </div>
        ...
        @endforeach
        <div class="row">
            <p class="" style="font-size:19px;font-weight: bold;margin:0;padding:5px 0">Chi tiết <span style="color:rgb(237,125,49);font-size: 19px;">/ Service Details</span></p>
             <div class="row">
            ...
            <table style="width:100%">
                <thead>
                    <tr>
                        <th><p style="">Tình trạng/<span class="color-span">Status/Error</span> </p></th>
                        <th><p style="">Nguyên nhân/<span class="color-span">Origin of trouble</span> </p></th>
                        <th><p style="">Cách khắc phục/<span class="color-span">Solution</span> </p></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    <td><p style="font-weight: normal;line-height: 90px">{{$warrantyDetails1->warranty_status_error}}</p> </td>
                    <td><p style="font-weight: normal;line-height: 90px">{{$warrantyDetails1->warranty_cause}}</p></td>
                    <td><p style="font-weight: normal;line-height: 90px">{{$warrantyDetails1->warranty_solution}}</p></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="border-bottom-doted">
            <p style="display:inline;padding-bottom: 15px">Ghi chú / <span class="color-span">Remark: </span> </p>
