...
<div class="title1">TÙY CHỌN HIỂN THỊ</div>
...
<div class="div-btn">
    ...
    <a class="btn btn1 btn-primary" href="{{route('export.excel.wr')}}"><i class="fa fa-cloud-download"></i>Xuất File Excel</a>
    <a class="btn btn1 btn-primary" href="{{route('export.service')}}"><i class="fa fa-cloud-download"></i>Xuất File PDF</a>
</div>
<table class="tb table-bordered ">
    ...
    @foreach($service_home as $key => $value)
        @can('view',$value)
        <tr class="bgr4">
            ...
            <td class="wr_start_date" style="">{{$value->start_date}}</td>
            <td class="wr_end_date">{{$value->end_date}}</td>
